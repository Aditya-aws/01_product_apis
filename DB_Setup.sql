...
-- Schema fullstack
-- -----------------------------------------------------
DROP SCHEMA IF EXISTS `ecomm_project`;

CREATE SCHEMA `ecomm_project`;
USE `ecomm_project` ;

-- -----------------------------------------------------
-- Table `fullstack`.`product_category`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ecomm_project`.`product_category` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ecomm_project`.`product` (
  `id` BIGINT(20) NOT NULL AUTO_INCREMENT,
